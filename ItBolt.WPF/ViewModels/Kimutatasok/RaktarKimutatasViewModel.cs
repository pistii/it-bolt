...
namespace ItBolt.WPF.ViewModels
{
    public class RaktarKimutatasViewModel : PagerViewModel, IEditCommands<Raktar>
    {
        ...
        private ObservableCollection<Raktar> SelectedRaktarak = new();
        ...
        public Raktar SelectedRaktar
        {
            ...
            set
            {
                ...
                if (!SelectedRaktarak.Contains(_selectedRaktar) && _selectedRaktar != null)
                {
                    SelectedRaktarak.Add(_selectedRaktar);
                }
        ...
        public RaktarKimutatasViewModel()
        {
        }
        ...
        private async Task SaveAsync(Raktar raktarak)
        {
            foreach (var raktar in SelectedRaktarak)
            {
        ...
        public bool RaktarKimutatasCanDelete(Raktar raktar)
        {
            return CanDelete(raktar);
        }
